...
plt.subplot(221)
#plt.ylim(22, 41)
plt.plot( [x+1 for x in range(len(dados[0]))], dados[0], label=controllerSDN[0], color= color[0],  marker= "o", markersize=2, linestyle='-',  lw=1) 
...
plt.subplot(222)
#plt.ylim(22, 41)
plt.plot( [x+1 for x in range(len(dados[3]))], dados[3], label=controllerSDN[1], color= color[1],  marker= "o", markersize=2, linestyle='-', lw=1) 
plt.legend(loc='best', numpoints=1, fancybox=True, framealpha=0.5)
plt.title('Percentual de CPU utilizado\n com 2 nós IoT')
plt.ylabel('CPU (%)')
plt.xlabel('Número de coletas')
...
plt.subplot(223)
#plt.ylim(22, 41)
plt.plot( [x+1 for x in range(len(dados[6]))], dados[6], label=controllerSDN[2], color= color[2],  marker= "o", markersize=2, linestyle='-', lw=1) 
plt.legend(loc='best', numpoints=1, fancybox=True, framealpha=0.5)
plt.title('Percentual de CPU utilizado\n com 2 nós IoT')
plt.ylabel('CPU (%)')
plt.xlabel('Número de coletas')
