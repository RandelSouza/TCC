...
for controller in controllerSDN:
    for quantity in nodesQuantity:
        arquivo = "{}/{}{}{}/latencia_min_{}_Nos_{}.txt".format(path, controller, "_Nos_", quantity, controller, quantity)
...
plt.plot([1, (nodesQuantity[0] * repeat_number)], [calc(dados[0])[0], calc(dados[0])[0] ], color='#FFFF00', linewidth=3, linestyle='-', label='Média')
plt.legend(loc='best', numpoints=1 , fancybox=True, framealpha=0.5)
plt.title('Latência mínima \n com 26 nós IoT (a)')
...
plt.plot([1, (nodesQuantity[0] * repeat_number)], [calc(dados[3])[0], calc(dados[3])[0] ], color='black', linewidth=3, linestyle='-', label='Média')
plt.legend(loc='best', numpoints=1, fancybox=True, framealpha=0.5)
plt.title('Latência mínima \n com 26 nós IoT (b)')
plt.ylabel('Latência (ms)')
plt.xlabel('Número de coletas')
...
plt.plot([1, (nodesQuantity[0] * repeat_number)], [calc(dados[6])[0], calc(dados[6])[0] ], color='blue', linewidth=3, linestyle='-', label='Média')
plt.legend(loc='best', numpoints=1, fancybox=True, framealpha=0.5)
plt.title('Latência mínima \n com 26 nós IoT (c)')
plt.ylabel('Latência (ms)')
plt.xlabel('Número de coletas')
...
plt.plot([1,(nodesQuantity[0] * repeat_number)], [calc(dados[0])[0], calc(dados[0])[0] ], color='#FFFF00', linewidth=3, linestyle='-', label='Média '+controllerSDN[0])
plt.plot([1, (nodesQuantity[0] * repeat_number)], [calc(dados[3])[0], calc(dados[3])[0] ], color='black', linewidth=3, linestyle='-', label='Média '+controllerSDN[1])
plt.plot([1, (nodesQuantity[0] * repeat_number)], [calc(dados[6])[0], calc(dados[6])[0] ], color='blue', linewidth=3, linestyle='-', label='Média '+controllerSDN[2])
